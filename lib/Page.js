...
class PageTemplate {
     ...
     */
    headerHTML() {
        const publicLinks = `<a href="/blog/">Blog</a>
                            <a href="/register/">Register</a>
                            <a href="/login/">Log in</a>`;
                            
        const userLinks = `Hello,<span style="text-decoration:underline; color:#f34879">${this.data.user.email}</span> 
                            <a href="/create-blog-post/">Create post</a>
                            <a href="/blog/">Blog</a>
