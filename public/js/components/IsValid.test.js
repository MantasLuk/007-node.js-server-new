...
describe('IsValid.username()', () => {
    describe('Ivestas netinkamas username', () => {
        test('username netinkamo tipo', () => {
            expect(IsValid.username(333)).toBe('Username type is wrong');
        });
        test('username nera', () => {
        ...
        test('username yra tinkamas', () => {
            expect(IsValid.username('Babaranas12')).toBe(true);
        });
    });
});
...
describe('IsValid.email()', () => {
    describe('Ivestas netinkamas email', () => {
        test('email netinkamo tipo', () => {
            expect(IsValid.email(3344666545)).toBe('Wrong type of email');
        });
        test('email nera', () => {
